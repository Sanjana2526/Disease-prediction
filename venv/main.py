...
base_dir = "C:\\Users\\SANJANA\\OneDrive\\Desktop\\Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning\\datasets"

# Check if the file exists before loading
precautions_path = os.path.join(base_dir, "precautions_df.csv")
if os.path.exists(precautions_path):
    precautions = pd.read_csv(precautions_path)
else:
    print(f"File not found: {precautions_path}")
    # Handle the missing file scenario
    # For example, you could raise an error, return None, or exit the program
    exit(1)
